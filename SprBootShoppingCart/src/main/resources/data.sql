...
values ('P01', CONCAT(@img_path,"/","parol",".png"), 'parol', 5, CURDATE());
 
insert into PRODUCTS (CODE, IMAGE_PATH, NAME, PRICE, CREATE_DATE)
values ('P02', CONCAT(@img_path,"/","aferin",".png"), 'aferin', 3, CURDATE());
 
insert into PRODUCTS (CODE, IMAGE_PATH, NAME, PRICE, CREATE_DATE)
values ('P03', CONCAT(@img_path,"/","klavunat",".png"), 'klavunat', 50, CURDATE());
 
insert into PRODUCTS (CODE, IMAGE_PATH, NAME, PRICE, CREATE_DATE)
values ('P04', CONCAT(@img_path,"/","silverdin",".png"), 'silverdin', 20, CURDATE());
 
insert into PRODUCTS (CODE, IMAGE_PATH, NAME, PRICE, CREATE_DATE)
values ('P05', CONCAT(@img_path,"/","vermidon",".png"), 'vermidon', 30, CURDATE());